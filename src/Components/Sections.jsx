        ...
        <div className="container">
            ...
            <span className="subtitle">My About Details</span>
                ...
                <ul className="nav nav-pills justify-content-center justify-content-lg-between mb-3" id="pills-tab" role="tablist">
                    ...
                    <button className="nav-link active" id="pills-skill-tab" data-bs-toggle="pill" data-bs-target="#pills-skill" type="button" role="tab" aria-controls="pills-skill" aria-selected="true">Main Skills</button>
                    </li>

                    <li className="nav-item" role="presentation">
                    <button className="nav-link" id="pills-bio-tab" data-bs-toggle="pill" data-bs-target="#pills-bio" type="button" role="tab" aria-controls="pills-experiance" aria-selected="false">Biography</button>
                    </li>
                ...
                <div className="tab-content" id="pills-tabContent">
                    ...
                    <ul className="text-start ps-0">
                        <li>
                        <Link to="#">
                            Mid. Front-end Engineer <span>- Reactjs</span>
                        </Link> 2022 - Current
                        </li>
                        <li>
                        <Link to="#">
                            Mid. Backend Engineer <span>- Php/Laravel</span>
                        </Link> 2021 - Current
                        </li>
                        <li>
                        <Link to="#">
                            Jr. Backend Engineer <span>- Node/Express</span>
                        </Link> 2022 - Current
                        </li>
                        <li>
                        <Link to="#">
                            Jr. Frontend Engineer <span>- Flutter</span>
                        </Link> 2022 - Current
                        </li>
                    </ul>
                    </div>
